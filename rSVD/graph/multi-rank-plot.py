...
plt.legend()
plt.tight_layout()
plt.savefig("./plots/loss_across_rank_fractions.png", dpi=300)
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig("./plots/peak_memory_per_epoch_across_rank_fractions.png", dpi=300)
plt.close()
...
if program_mem_summary:
    ...
    plt.grid(True, linestyle="--", alpha=0.5)
    plt.tight_layout()
    plt.savefig("./plots/total_program_memory_vs_rank_fraction.png", dpi=300)
    plt.close()
...
if forward_mem_summary:
    ...
    plt.grid(True, linestyle="--", alpha=0.5)
    plt.tight_layout()
    plt.savefig("./plots/forward_memory_vs_rank_fraction.png", dpi=300)
    plt.close()
...
if forward_flops_summary:
    ...
    plt.grid(True, linestyle="--", alpha=0.5)
    plt.tight_layout()
    plt.savefig("./plots/forward_flops_vs_rank_fraction.png", dpi=300)
    plt.close()
    print("✓ Saved forward_flops_vs_rank_fraction.png")

print(f"\n🔥 All multi-rank-fraction rSVD plots saved to: ./plots/")
