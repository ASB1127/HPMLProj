"""
Multi-rank-fraction plotting script for rSVD SVT experiments.
Aggregates metrics from multiple rank-fraction directories and generates 
comparison plots for loss, memory, and compute cost.
"""
import pandas as pd
...
def rank_fraction_to_dir(rf):
    """Converts a rank fraction value to its corresponding directory name (e.g., 0.3 -> r0_3)."""
